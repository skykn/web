...
- This project uses [Maple Mono](https://font.subf.dev/zh-cn/) as the default monospace font for code, while body text uses the cross-platform system font stack. Maple Mono is distributed under the OFL 1.1 license, with the license text available at `licenses/LICENSE-maple-mono.txt`.
